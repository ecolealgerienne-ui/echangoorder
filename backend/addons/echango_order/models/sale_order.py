...
class SaleOrder(models.Model):
    ...
    # _prep_status`). Non pertinent pour un retrait en magasin (`x_
    # reception_mode = 'pickup'`), où la validation du bon de livraison
    # suffit à marquer la commande récupérée.
