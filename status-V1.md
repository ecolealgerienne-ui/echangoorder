...
- [ ] Concevoir un signal de disponibilité stock exposable au portail sans ouvrir tout le module stock (`qty_available` retiré du catalogue F04 — voir §0 — nécessaire avant le badge "Épuisé" et avant `checkout.out_of_stock` en F07)
